 ...
 */
 let Study =  function (details){
    ...
    this.startDate = (details.startDate) ? new Date(details.startDate) : new Date( details.s_start_date)
    this.endDate = (details.endDate) ? new Date(details.endDate) : new Date( details.s_end_date)
